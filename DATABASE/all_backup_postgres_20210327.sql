...
ALTER TABLE lettnbbs ALTER COLUMN parntsctt_no TYPE text;
ALTER TABLE lettnbbs ALTER COLUMN answer_lc TYPE text;
...
ALTER TABLE lettnfiledetail ALTER COLUMN file_sn TYPE text;
ALTER TABLE lettnfiledetail ALTER COLUMN file_size TYPE text;
